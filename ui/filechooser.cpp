   ...
   void FileChooser::paintEvent( QPaintEvent * )
{
  ...
  //Scale of the graph
	...
	//QPoint point=FileChooser::getGraph->pos();
        ...
        //int gradEndY = gradStartY+h;
//filling the background
        //painter.drawRect(xp1,yp+20,xp,h );
...
//filling the clor gradient    
        ...
        //painter.drawRect(leftMargin-graphOutlineWidth, topMargin-graphOutlineWidth, graphWidth+graphOutlineWidth*2, graphHeight+graphOutlineWidth*2);
