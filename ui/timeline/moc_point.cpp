...
**
** Created: Sun Mar 20 22:29:21 2011
...
static const char qt_meta_stringdata_Point[] = {
    "Point\0\0startTimeLine()\0checkoutVersion()\0"
    "revertToVersion()\0tagVersion()\0"
};

const QMetaObject Point::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Point,
...
void *Point::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Point*>(this));
...
int Point::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: startTimeLine(); break;
        case 1: checkoutVersion(); break;
        case 2: revertToVersion(); break;
        case 3: tagVersion(); break;
        default: ;
        }
        _id -= 4;
    }
