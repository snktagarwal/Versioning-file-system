...
**
** Created: Sun Mar 20 22:29:24 2011
...
static const char qt_meta_stringdata_GraphWindow[] = {
    "GraphWindow\0\0showDocument()\0p\0"
    "startTimeLine(Point*)\0min,max\0"
...
int GraphWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: showDocument(); break;
        case 1: startTimeLine((*reinterpret_cast< Point*(*)>(_a[1]))); break;
        case 2: updateRange((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 3;
    }
